...
export default function TopBar({ fileName, versionLabel, debugMode, onToggleDebug }: TopBarProps) {
    ...
    <header className="h-14 shrink-0 border-b border-[#e9ecef] bg-white flex items-center justify-between px-6">
      ...
      <div className="flex items-center gap-4 min-w-0">
        <div className="flex items-center gap-2.5 shrink-0">
          ...
          <span className="text-sm font-semibold text-[#1a1a2e]">数据工作台</span>
        </div>
      ...
      <div className="flex items-center gap-1">
        ...
        <button onClick={() => setShowSettings(true)} className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs text-[#6b7280] hover:bg-[#f3f4f6] transition-colors">
        ...
        <button className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs text-[#6b7280] hover:bg-[#f3f4f6] transition-colors">
